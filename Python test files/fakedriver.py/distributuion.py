...
# Beispielhafte Verbrauchsdaten erstellen mit stündlichen Werten zwischen 3000 und 10000 kW
num_time_points = 24 * 7  # Eine Woche mit stündlichen Werten
np.random.seed(42)
...
run_simulation(num_time_points=num_time_points,
               ...
               battery_mode='default',  # 'default' oder 'peak_shaving'
